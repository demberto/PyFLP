...
entire end-user documentation lies in its `reference <../reference>`_.
...
The docstrings are `good enough <./features>`_ to give a feel of what you are
doing, so you won't need to visit the documentation a lot, once you know how
the API layout is.
